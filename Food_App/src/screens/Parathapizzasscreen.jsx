...
import Parathapizza from '../components/NonvegPizzascreen';
import Navbar from '../components/Navbar';
import PizzaNavbar from '../components/PizzaNavbar';
import "./nonvegs.css"

function Parathapizzascreen() {
  ...
  const filteredPizzas = pizzas.filter((item) => item.page?.includes("Paratha"));
...
export default Parathapizzascreen
